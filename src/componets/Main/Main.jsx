...
const Main = () => {
  ...
  return (
    <div className='main'>
      ...
      <div className="cards">
        <div className="card">
          <p>Suggest beutifull place to see on upcoming road trip.</p>
          <img src={assets.compass_icon} alt="" />
        </div>

        <div className="card">
          <p>Brifely summarize this concept:Artificial Intelligence</p>
      ...
      <div className='result'>
        ...
        <div className="result_data">
          ...
          <hr />
          <hr /></div>: <p dangerouslySetInnerHTML={{__html:resultData}}></p>}
